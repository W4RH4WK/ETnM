...
% TODO padding calculation + nop sledge
...
\begin{frame}[fragile]{A look at GCC}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{ccode*}{autogobble,xleftmargin=1em}
                #include <stdio.h>
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{pre*}{autogobble}
                ...
                Stack
                ------------------------
                0x00007fffffffe280: 0x0a41414141414141
                0x00007fffffffe288: 0x4848c5a0bbf40c00 (CANARY)
                0x00007fffffffe290: 0x00007fffffffe2b0 (Saved RBP)
                0x00007fffffffe298: 0x00000000004006a4 (Saved RIP)
                ------------------------
                Stack Pointer: 0x00007fffffffe280
                Stack Base:    0x00007fffffffe290
                Canary:        0x4848c5a0bbf40c00
                saved RIP:     0x00000000004006a4
            \end{pre*}
        \end{column}
    \end{columns}
\end{frame}
